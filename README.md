...
-   **Libraries**:
    ...
    -   [Google Fonts](https://fonts.google.com/) (Poppins & Open Sans)
...
2.  **Run locally:**
    You can open `index.html` directly in your browser, or use a simple local server for the best experience (especially for loading assets).
